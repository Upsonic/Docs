---
title: Install Upsonic CE with Docker on WSL / Docker Desktop

---
 

<Info>
These installation instructions are for Upsonic Community Edition (CE). For Upsonic Business Edition (BE) refer to the BE install documentation.
</Info>
