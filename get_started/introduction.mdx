   ...
   <Container>
    ...
    <div className="flex justify-center mt-8">
      <a href="/concepts">
        <button
          type="button"
          className="px-6 flex items-center font-medium text-sm rounded-full py-3 shadow-sm text-white dark:text-gray-900 bg-primary-dark dark:bg-primary-light hover:opacity-[0.9] hover:bg-primary justify-center"
        >
          View All Guides
          <svg
            className="size-4 ml-2 bg-white dark:bg-gray-900"
            style={{
              maskImage: 'url("https://mintlify.b-cdn.net/solid/arrow-right-long.svg")',
              maskRepeat: 'no-repeat',
              maskPosition: 'center center'
