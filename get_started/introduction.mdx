...
import { GuideCard } from '/snippets/home/guide-cards.mdx';
...
<div className="px-5 divide-y divide-gray-100 dark:divide-white/10">
  ...
  <div className="w-full px-5 py-4 dark:bg-gray-900">
   ...
   <Container>
    ...
    <CardGroup cols={3}>
        <GuideCard
        title="1. Creating an Agent"
        description="Learn how to create and configure AI agents with the Upsonic framework"
        href="/concepts/agent"
        ...
        <GuideCard
          ...
          description="Connect your agent with real-world tools and information sources"
          href="/concepts/tools"
        ...
        />
          ...
          description="Integrate Model Context Protocol tools with your agents"
          href="/concepts/mcp_tools"
        ...
        <GuideCard
          ...
          description="Implement memory capabilities to make your agents more context-aware"
        ...
        <GuideCard
          ...
          description="Build multi-agent systems for complex problem solving"
          href="/concepts/team"
          img="https://mintlify-assets.b-cdn.net/aspen-chat.svg"
          model="Team"
          type="Guide"
  ...
  <Container>
    <div className="flex flex-col w-full mb-8">
      <div className="flex items-center justify-between w-full">
        <Title>
          Upsonic Infra Ecosystem
        </Title>
      </div>
      <p
        className="text-[#5B616E] dark:text-gray-300 text-md mb-1 mt-3"
      >
        Comprehensive infrastructure for building and deploying AI agents at scale.
      </p>
    </div>
