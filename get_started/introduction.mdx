...
<Info>
  Read our safety first policy from here.
</Info>
...
- [1. Create an Agent](/concepts/agent)
- [2. Adding Tools to an Agent](/concepts/agent)
- [3. Adding MCP Tools to an Agent](/concepts/agent)
- [4. Using Memory in your Agent](/concepts/agent)
- [5. Creating a Team of the Agents](/concepts/agent)

## We are building The Ecosystem

We have a AI Agent Framework and AgentOS with industry-leading safety features. Our service department is building ready-to-use AI Agents across various business workflows. When you use Upsonic, you gain access to compatible AI Agent software solutions.

## Differentation

Developers using other frameworks constantly have to choose between simplicity and sophistication. At the same time, most of their effort goes into making the AI safe. Yet, even after all that, they can never be certain.

We are focusing on Safety and Customization in our Framework and AgentOS. We are providing the most detailed Safety Settings and Agent behavior systems.
