...
![Githup Banner2 Pn](/images/githup-banner2.png)

Upsonic is the AI Agent Development Framework that used by the fintech leaders and tested at their scale against attacks and reasoning puzzles.
...
<CardGroup cols={3}>
  <Card title="Agents" icon="robot" href="/concepts/agents/overview">
    Build safety-first AI agents with direct LLM calls.
  </Card>
  <Card title="Teams" icon="users" href="/concepts/team">
    Create reliable multi-agent teams with memory.
  </Card>
  <Card title="Models" icon="box" href="/reference/models/model">
    Use any model with unified interface.
  </Card>
  <Card title="Tools" icon="wrench" href="/concepts/tools/custom_tools">
    Extend agents with MCP tools.
  </Card>
  <Card title="Safety Engine" icon="shield-check" href="/concepts/safety_engine">
    Customizable safety policies and rules.
  </Card>
  <Card title="Knowledge Base" icon="database" href="/concepts/knowledge_base">
    Built-in RAG with agentic capabilities.
  </Card>
  <Card title="Memory" icon="lightbulb" href="/concepts/memory">
    Customizable memory for user, event, chat.
  </Card>
  <Card title="Structured Outputs" icon="code" href="/concepts/tasks/response_format">
    Python object outputs for easy integration.
  </Card>
  <a href="https://upsonic.ai/agent-platform" target="_blank" rel="noopener noreferrer">
  <Card title="AgentOS" icon="monitor">
    Track executions and monitor agents.
  </Card>
  </a>

  <Card title="Deployment(FastAPI)" icon="rocket" href="/concepts/deployment">
