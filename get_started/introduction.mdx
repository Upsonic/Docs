...
<div className="px-5 divide-y divide-gray-100 dark:divide-white/10">
  <Container>
   ...
   <Container>
    ...
    <Columns cols={2}>
      <Card title="1. Creating an Agent" icon="panel-left-close" href="/concepts/agent">
        Learn how to create and configure AI agents with the Upsonic framework
      </Card>
      <Card title="2. Adding Tools to an Agent" icon="panel-right-close" href="/concepts/tools">
        Connect your agent with real-world tools and information sources
      </Card>
      <Card title="3. Adding MCP Tools to an Agent" icon="panel-left-close" href="/concepts/mcp_tools">
        Integrate Model Context Protocol tools with your agents
      </Card>
      <Card title="4. Using Memory in your Agent" icon="panel-right-close" href="/concepts/memory">
        Implement memory capabilities to make your agents more context-aware
      </Card>
      <Card title="5. Creating a Team of the Agents" icon="panel-left-close" href="/concepts/team">
