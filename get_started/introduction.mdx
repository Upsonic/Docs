  ...
  <Container>
   ...
   <Container>
    <div className="flex flex-col w-full mb-8">
      ...
      <p
        className="text-[#5B616E] dark:text-gray-300 text-md mb-4 mt-3"
      >
        Upsonic provides a comprehensive framework for building intelligent AI agents with advanced capabilities and safety features.
      </p>
      <ul className="text-[#5B616E] dark:text-gray-300 text-md mb-8 space-y-2">
        <li className="flex items-start">
          <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
          <span>Built-in AI Safety Engine ensures responsible AI development and deployment</span>
        </li>
        <li className="flex items-start">
          <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
          <span>Multi-agent architecture enables complex problem-solving through collaboration</span>
        </li>
        <li className="flex items-start">
          <span className="text-blue-600 dark:text-blue-400 mr-2">•</span>
          <span>Advanced memory and knowledge base systems for context-aware interactions</span>
        </li>
      </ul>
    </div>
   </Container>
