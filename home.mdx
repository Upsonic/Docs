...
<CardGroup cols={2}>
  ...
  The official client to access and use the Upsonic Server or Cloud System.
  </Card>
  <Card title="Server" icon="server" href="/server/welcome">
    Documentation for installing an Upsonic server to server infrastructure.
  </Card>
</CardGroup>
