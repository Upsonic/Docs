...
![AI Writing Assistant Landing Page](../../artifacts/AI_Writing_Assistant_landing_page.png)
...
def main(inputs: Dict[str, Any]) -> Dict[str, Any]:
    ...
    model = inputs.get("model", "openai-responses/gpt-5")
...
def create_orchestrator_agent(
    model: str = "openai-responses/gpt-5",
...
def create_content_writer_subagent(model: str = "openai/gpt-5-mini") -> Agent:
...
def create_designer_subagent(model: str = "openai/gpt-5-mini") -> Agent:
...
def create_seo_specialist_subagent(model: str = "openai/gpt-5-mini") -> Agent:
...
```json
{
    ...
    "input_schema": {
        "inputs": {
            ...
            "model": {
                "type": "string",
                "description": "Optional model identifier (e.g., openai-responses/gpt-5, openai-responses/gpt-5-mini)",
                "required": false,
...
View the complete example: [Landing Page Generation Agent](https://github.com/Upsonic/Examples/task_examples/landing_page_generation)
