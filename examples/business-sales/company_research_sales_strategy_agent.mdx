...
def main(inputs: Dict[str, Any]) -> Dict[str, Any]:
    ...
    model = inputs.get("model", "openai/gpt-5")
...
def create_research_subagent(model: str = "openai/gpt-5-mini") -> Agent:
...
def create_industry_analyst_subagent(model: str = "openai/gpt-5-mini") -> Agent:
...
def create_financial_analyst_subagent(model: str = "openai/gpt-5-mini") -> Agent:
...
def create_sales_strategist_subagent(model: str = "openai/gpt-5-mini") -> Agent:
...
```json
{
    ...
    "input_schema": {
        "inputs": {
            ...
            "model": {
                "type": "string",
                "description": "Optional model identifier (e.g., openai/gpt-5, openai/gpt-5-mini)",
                "required": false,
...
View the complete example: [Company Research & Sales Strategy Agent](https://github.com/Upsonic/Examples/company_research_sales_strategy)
