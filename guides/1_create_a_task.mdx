...
- **Attachment Support**: Include file attachments (images, documents) in tasks for multimodal processing capabilities.
...
For detailed examples and advanced patterns, see our comprehensive [Task Concept Documentation](https://docs.upsonic.ai/concepts/task).