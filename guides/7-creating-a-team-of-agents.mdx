...
agent1 = Agent(model="openai/gpt-4o", name="Agent 1", role="Helper")
agent2 = Agent(model="openai/gpt-4o", name="Agent 2", role="Helper") 
agent3 = Agent(model="openai/gpt-4o", name="Agent 3", role="Helper")
```
