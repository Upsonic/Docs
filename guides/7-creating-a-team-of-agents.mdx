...
agent1 = Agent(model="openai/gpt-5", name="Agent 1", role="Helper")
agent2 = Agent(model="openai/gpt-5", name="Agent 2", role="Helper") 
agent3 = Agent(model="openai/gpt-5", name="Agent 3", role="Helper")
```
