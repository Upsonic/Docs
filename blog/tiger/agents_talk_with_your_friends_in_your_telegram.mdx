...
```bash
pip3 instal crewai 'crewai[tools]' upsonic
...
## Creating Agents
### OpenAI Connection
In this point we will use `gpt-4-0125-preview` for more context.
```python
...
telegram_task = Task(
  description="""Writing friendly and solution-focus answers to unreaded messages in telegram""",
