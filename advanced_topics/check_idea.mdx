...
<Warning> Users who use the LLaMA-3 model with 8 billion parameters cannot access the check_idea function. But ther can use [upsonic.search](/client/using/ai/search) function as well. </Warning>
