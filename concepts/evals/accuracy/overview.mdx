...
<CardGroup cols={3}>
  ...
  <Card title="Agent" icon="robot" href="/evals/accuracy/usages/agent">
    Evaluate a single agent
  </Card>

  <Card title="Team" icon="users" href="/evals/accuracy/usages/team">
    Evaluate a multi-agent team
  </Card>

  <Card title="Graph" icon="diagram-project" href="/evals/accuracy/usages/graph">
