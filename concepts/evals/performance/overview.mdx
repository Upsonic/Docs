...
<CardGroup cols={3}>
  ...
  <Card title="Agent" icon="robot" href="/evals/performance/usages/agent">
    Profile a single agent
  </Card>

  <Card title="Team" icon="users" href="/evals/performance/usages/team">
    Profile a multi-agent team
  </Card>

  <Card title="Graph" icon="diagram-project" href="/evals/performance/usages/graph">
