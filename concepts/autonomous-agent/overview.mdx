...
agent.print_do("Read the main.py file and explain what it does")
```
...
- [Creating an Autonomous Agent](/autonomous-agent/creating-an-autonomous-agent) - Learn how to create and configure autonomous agents
- [Attributes](/autonomous-agent/attributes) - Comprehensive guide to all configuration options
- [Running an Autonomous Agent](/autonomous-agent/running-an-autonomous-agent) - Execute agents with different methods
- [Filesystem Tools](/autonomous-agent/advanced/filesystem-tools) - Detailed guide to filesystem operations
- [Shell Tools](/autonomous-agent/advanced/shell-tools) - Guide to shell command execution
- [Workspace Security](/autonomous-agent/advanced/workspace-security) - Sandboxing and security features
- [Memory Integration](/autonomous-agent/advanced/memory-integration) - Session persistence and storage
