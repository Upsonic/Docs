...
agent.do("Read src/main.py")           # /home/user/my-project/src/main.py
agent.do("Read ./config.json")         # /home/user/my-project/config.json

# Path traversal is blocked
agent.do("Read ../other-project/secret.txt")  # Blocked - outside workspace
agent.do("Read /etc/passwd")                   # Blocked - absolute path outside workspace
```
...
agent.do("Read config.py and utils.py, then update utils.py")
