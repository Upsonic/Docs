...
agent.print_do("Find all Python files that contain 'TODO' comments and list them with line numbers")
```
...
agent.print_do("Add type hints to all functions in utils.py")
```
