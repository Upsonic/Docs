...
<CardGroup cols={3}>
  <Card title="Cancel Run" icon="stop" href="/docs/hitl/cancel-run">
    Cancel running agent executions and resume from the cut-off point.
  </Card>
  <Card title="Durable Execution" icon="rotate" href="/docs/hitl/durable-execution">
    Automatic recovery from errors with state persistence across restarts.
  </Card>
  <Card title="External Tool Execution" icon="plug" href="/docs/hitl/external-tool-execution">
