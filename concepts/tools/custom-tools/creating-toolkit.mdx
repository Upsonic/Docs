...
agent = Agent(model="openai/gpt-4o", name="File Agent")
...
agent = Agent(model="openai/gpt-4o", name="Admin Agent")
...
agent = Agent(model="openai/gpt-4o", name="Payment Agent")
task = Task(
...
agent = Agent(model="openai/gpt-4o", name="Deploy Agent")
...
agent = Agent(model="openai/gpt-4o", name="GitHub Agent")
task = Task(
...
toolkit = MathToolKit()
agent = Agent(model="openai/gpt-4o", name="Math Agent", tools=[toolkit])
