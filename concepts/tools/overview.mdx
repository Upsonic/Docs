...
- [Model Provider Tools](/concepts/tools/ready-to-use-tools/model-provider-tools/supported-providers) - Use built-in tools from model providers
- [Ready to Use Tools](/concepts/tools/ready-to-use-tools/function-tools/duckduckgo) - Pre-built class tools, function tools, and toolkits
