---
title: "UrlContextTool (Deprecated)"
description: "Allows models to access and read contents from URLs directly (deprecated, use WebFetchTool instead)"
---

> **Deprecated**: `UrlContextTool` is deprecated. Use [`WebFetchTool`](/model-provider-tools/tools/web-fetch-tool) instead, which provides the same functionality with additional configuration options.
