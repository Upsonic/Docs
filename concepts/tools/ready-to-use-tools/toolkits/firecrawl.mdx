...
<Info>
**ToolKit:** FirecrawlTools inherits from [ToolKit](/concepts/tools/custom-tools/creating-toolkit). You get all base behavior (e.g. `include_tools`, `exclude_tools`, `timeout`, `use_async`). See [Creating ToolKit](/concepts/tools/custom-tools/creating-toolkit) for the full API.
</Info>
