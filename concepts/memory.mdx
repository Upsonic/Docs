...
Make your AI agents remember previous conversations, learn about your users, and provide personalized experiences that improve over time.
...
async def run_production_agent():
    # Production storage
    storage = PostgresStorage(
        sessions_table_name="production_sessions",
        profiles_table_name="production_profiles",
        db_url="postgresql://prod_user:secure_pass@db.example.com:5432/prod_db",
        schema="agent_memory"
    )
