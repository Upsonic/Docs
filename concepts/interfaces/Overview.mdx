...
<CardGroup cols={2}>
  ...
  <Card title="Slack" icon="slack" href="/integrations/interfaces/slack">

    Deploy agents as Slack applications for team collaboration

  </Card>

  <Card title="WhatsApp" icon="whatsapp" href="/integrations/interfaces/whatsapp">

    Serve agents via WhatsApp for direct messaging interactions

  </Card>

  <Card title="Telegram" icon="telegram" href="/integrations/interfaces/telegram">

    Host agents as Telegram bots with webhooks, multi-media, and task or chat modes

  </Card>

  <Card title="Gmail" icon="envelope" href="/integrations/interfaces/gmail">
