...
| `health_check` | None | `Dict[str, Any]` | Returns health status, configuration (bot connectivity, mode, reset_command, whitelist, parse_mode, behavior flags), and optional bot info from Telegram. |
