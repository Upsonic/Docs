...
2. **Session Greeting**: You can call `_execute_workspace_greeting()` to generate a personalized greeting based on the configuration
...
greeting = agent._execute_workspace_greeting()
print(greeting)
