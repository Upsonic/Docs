...
Uses gpt-5 to analyze your task and intelligently select the best model. Recommended for complex or ambiguous tasks.
...
print(f"Model: {recommendation.model_name}")           # e.g., "openai/gpt-5"
...
- **OpenAI**: gpt-5, gpt-5-mini, O1-Pro, O1-mini
