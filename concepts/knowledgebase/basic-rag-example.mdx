...
- Check [vector stores](/integrations/vector-stores/chroma) for other vector databases
- See [embedding providers](/integrations/embedding-providers/openai) for other embedding models
