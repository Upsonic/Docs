...
<Note>
  **Example: Setting up for PDF files with Chroma**
  ...
  ```bash
  pip install "upsonic[chroma,pdf-loader]"
  ```
  ...
  **What you need:**
  ...
  The examples below use Chroma and PDF loader, but you can use any combination of supported providers and loaders. See [Storage Providers](/knowledgebase/storage-providers/chroma) and [Loaders](/knowledgebase/loaders/pypdf) for all options.
</Note>
