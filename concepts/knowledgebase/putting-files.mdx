...
<Note>
  ...
  **What you need:**
  ...
  The examples below use Chroma and PDF loader, but you can use any combination of supported providers and loaders. See [Vector Stores](/integrations/vector-stores/chroma) and [Document Loaders](/integrations/document-loaders/pypdf) for all options.
</Note>
