...
<CardGroup cols={2}>
  <Card title="Conditional Routing" icon="code-branch" href="https://docs.upsonic.ai/concepts/stategraph/state-graph-core-concepts#conditional-routing" target="_self">
