...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="https://docs.upsonic.ai/concepts/stategraphhttps://docs.upsonic.ai/concepts/stategraph/state-graph-quickstart">
    Get started with your first StateGraph
  </Card>
  <Card title="Core Concepts" icon="book" href="https://docs.upsonic.ai/concepts/stategraph/state-graph-core-concepts">
  ...
  <Card title="Human-in-Loop" icon="user" href="https://docs.upsonic.ai/concepts/stategraph/state-graph-human-in-loop">
