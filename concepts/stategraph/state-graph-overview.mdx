...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="/state-graph-quickstart">
    Get started with your first StateGraph
  </Card>
  <Card title="Core Concepts" icon="book" href="/state-graph-core-concepts">
  ...
  <Card title="Human-in-Loop" icon="user" href="/state-graph-human-in-loop">
