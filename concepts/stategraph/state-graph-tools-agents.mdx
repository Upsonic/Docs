...
<CardGroup cols={2}>
  ...
  <Card title="Human-in-Loop" icon="user-check" href="https://docs.upsonic.ai/concepts/stategraphhttps://docs.upsonic.ai/concepts/stategraph/state-graph-human-in-loop">
    Add human oversight
  </Card>
</CardGroup>
