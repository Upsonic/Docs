...
|-----------|------|---------|-------------|
| `model` | `str` or `Model` | `"openai/gpt-5"` | Model identifier or Model instance |
...
analyst = Agent("openai/gpt-5", name="analyst", system_prompt="Data analysis expert")
