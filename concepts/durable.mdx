...
# Execute the task
agent = Agent("openai/gpt-5-mini", name="DataProcessor")
try:
...
# Resume execution
execution_id = "20251027123456-a1b2c3d4"
agent = Agent("openai/gpt-5-mini", name="Worker")
...
agent = Agent("openai/gpt-5-mini", name="Worker", debug=True)
...
async def main():
    ...
    # Create agent
    agent = Agent("openai/gpt-5-mini", name="DataProcessor", debug=True)
    ...
    try:
        ...
        try:
            ...
            recovery_agent = Agent("openai/gpt-5-mini", name="RecoveryAgent", debug=True)
