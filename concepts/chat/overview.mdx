...
- [Attributes](/chat/attributes) - Configuration options
- [Creating a Chat](/chat/creating-a-chat) - Initialization and configuration
- [Running a Chat](/chat/running-a-chat) - Sending messages and streaming
- [Metrics](/chat/metrics) - Cost and session analytics
- [History Management](/chat/history-management) - Message and attachment manipulation
- [Storage Backends](/chat/storage-backends) - Persistence options
- [Advanced](/chat/advanced/memory-strategies) - Advanced configuration
- [Examples](/chat/examples/basic) - Complete working examples
