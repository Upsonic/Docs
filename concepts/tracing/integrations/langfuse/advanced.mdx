...
{/* Screenshot: Langfuse trace detail showing scores */}
...
{/* Screenshot: Langfuse Score Configs page */}
...
{/* Screenshot: Langfuse Datasets page showing items and run results */}
...
{/* Screenshot: Langfuse Annotation Queue page */}
