...
<CardGroup cols={1}>
  <Card title="Langfuse Integration" icon="chart-line" href="/integrations/tracing/langfuse">
    Send traces to Langfuse for LLM-specific dashboards, cost tracking, and prompt management.
  </Card>
  <Card title="PromptLayer Integration" icon="chart-line" href="/integrations/tracing/promptlayer">
