...
The tasks are can be basic or complex by your aim. In the framework side we design to have onyl one parameter needed, description. Other parameters are Optional.
