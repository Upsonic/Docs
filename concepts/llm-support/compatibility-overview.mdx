...
| **Anthropic** |
| Anthropic | claude-3-5-sonnet-20241022 | 200K | 8K | Cached context supported |
| Anthropic | claude-3-5-haiku-20241022 | 200K | 8K | Fast variant |
| Anthropic | claude-opus-4-20250514 | 200K | 8K | Most capable |
| **Google** |
...
| **Mistral** |
| Mistral | mistral-large-latest | 128K | 8K | Latest |
| **Others** |
| Cohere | command-r-plus | 128K | 4K | Standard |
| Groq | llama-3.3-70b-versatile | 128K | 8K | Fast inference |
| Grok | grok-4 | 128K | 4K | Standard |
| Bedrock | anthropic.claude-3-5-sonnet-20241022-v2:0 | 200K | 8K | Via Bedrock |
...
| Huggingface | Token | `HF_TOKEN` | None |
...
| Huggingface | `HuggingFaceModel` | `Model` | `upsonic.models.huggingface` |
...
- Explore [Native Providers](/concepts/llm-support/native-providers/native-providers-openai) for direct API access
- Check [Local Providers](/concepts/llm-support/local-providers/local-providers-ollama) for local development
- Learn about [Model Gateways](/concepts/llm-support/model-gateways/model-gateways-openrouter) for unified access
- Review [OpenAI-Compatible](/concepts/llm-support/openai-compatible) providers for flexibility
