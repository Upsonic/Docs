...
Use OpenAI-compatible models by specifying the provider:
...
# OpenAI
model_openai = OpenAIChatModel(model_name="gpt-4o", provider="openai")

# DeepSeek - same interface
model_deepseek = OpenAIChatModel(model_name="deepseek-chat", provider="deepseek")

# Cerebras - same interface
model_cerebras = OpenAIChatModel(model_name="llama-3.3-70b", provider="cerebras")
