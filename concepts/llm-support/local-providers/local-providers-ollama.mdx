...
model = OpenAIChatModel(model_name="codellama", provider="ollama")
agent = Agent(model=model)
...
model = OpenAIChatModel(model_name="llava", provider="ollama")
agent = Agent(model=model)
...
model = OpenAIChatModel(model_name="mycustommodel", provider="ollama")
```
