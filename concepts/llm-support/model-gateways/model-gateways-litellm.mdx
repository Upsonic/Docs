...
gpt_model = OpenAIChatModel(model_name="gpt-4o", provider="litellm")
claude_model = OpenAIChatModel(model_name="claude-sonnet", provider="litellm")
gemini_model = OpenAIChatModel(model_name="gemini-flash", provider="litellm")
...
model = OpenAIChatModel(model_name="claude-sonnet", provider="litellm")
agent = Agent(
    model=model,
