...
model = infer_model("openai/gpt-5").add_memory(history=True, mode="always")
model = infer_model("openai/gpt-5").add_memory(history=True, mode="never")
model = infer_model("openai/gpt-5").add_memory(history=True, mode="record_all")

# Enable debug logging
model = infer_model("openai/gpt-5").add_memory(history=True, debug=True)
```
...
```python
model = infer_model("gpt-5").add_memory(history=True, mode="auto")
...
```python
model = infer_model("gpt-5").add_memory(history=True, mode="always")
...
```python
model = infer_model("gpt-5").add_memory(history=True, mode="never")
...
```python
model = infer_model("gpt-5").add_memory(history=True, mode="record_all")
...
```python
model = infer_model("gpt-5").add_memory(history=True, mode="auto", debug=True)
```
