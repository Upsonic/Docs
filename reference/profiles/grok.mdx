---
title: GrokModelProfile
sidebarTitle: GrokModelProfile
---
...
- `model_name` (str): The name of the Grok model

**Returns:**

- `ModelProfile | None`: The model profile for the Grok model, or None if no specific profile is defined

**Description:**

This function returns the model profile for a Grok model. Currently, it returns None as no specific profile configuration is implemented for Grok models.
