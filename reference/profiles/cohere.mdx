---
title: CohereModelProfile
sidebarTitle: CohereModelProfile
---
...
- `model_name` (str): The name of the Cohere model

**Returns:**

- `ModelProfile | None`: The model profile for the Cohere model, or None if no specific profile is defined

**Description:**

This function returns the model profile for a Cohere model. Currently, it returns None as no specific profile configuration is implemented for Cohere models.
