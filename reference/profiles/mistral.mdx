---
title: MistralModelProfile
sidebarTitle: MistralModelProfile
---
...
- `ModelProfile | None`: The model profile for the Mistral model, or None if no specific profile is defined

**Description:**

This function returns the model profile for a Mistral model. Currently, it returns None as no specific profile configuration is implemented for Mistral models.
