...
| `model_provider`                   | `Optional[Model | str]`                               | `"openai/gpt-4o-mini"` | Model provider for canvas editing operations                                                                                                                                                                                    |
...
canvas = Canvas("Technical Documentation", model_provider="openai/gpt-4o")
