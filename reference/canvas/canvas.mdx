...
| `model`                   | `Optional[Model | str]`                               | `"openai/gpt-5-mini"` | Model provider for canvas editing operations                                                                                                                                                                                    |
...
canvas = Canvas("Technical Documentation", model="openai/gpt-5")
...
# Use with agent
agent = Agent("openai/gpt-5", tools=canvas_functions)
```
