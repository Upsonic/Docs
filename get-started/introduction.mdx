...
<CardGroup cols={2}>
  ...
  <Card title="Skills" icon="graduation-cap" href="/concepts/autonomous-agent/skills">
    Package reusable capabilities as workspace folders your autonomous agent discovers and runs on demand.
  </Card>
