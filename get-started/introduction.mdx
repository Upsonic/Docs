...
<CardGroup cols={3}>
  ...
  <Card title="Tools" icon="wrench" href="/concepts/tools/custom-tools">
    Extend agents with MCP tools.
  </Card>
  <Card title="Safety Engine" icon="shield-check" href="/concepts/safety-engine">
  ...
  <Card title="Structured Outputs" icon="code" href="/concepts/tasks/response-format">
