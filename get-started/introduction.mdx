...
description: "**Upsonic is the AI Agent Development Framework that used by the fintech and banks.**"
mode: "wide"
...
You can use Upsonic framework to build safety-first AI Agents or teams with Memory, KnowledgeBase, OCR, Human in The Loop, tools and MCP Support. Upsonic framework orchestrate all of the operations with its pipeline architecture. 

You are able to create complex and basic agents in one unified agents. Our development process base on the what our community wants. Currently we are double down to Safety Engine and OCR capabilties.
